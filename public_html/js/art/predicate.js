...
define(['underscore', 'art/direction', 'paper'], function(_, Direction, paper) {
    ...
    var Predicate = {
        ...
        cellOutsideCircle: function(circle, gridPoint, config, threshold) {
            return function(cell) {
                return !Predicate.cellInsideCircle(circle, gridPoint, config, threshold)(cell);
            };
        }, 
        ...
        cellBetweenCircles: function(innerCircle, outerCircle, point, config, threshold) {
            return function(cell) {
                return Predicate.cellOutsideCircle(innerCircle, point, config, threshold)(cell) && Predicate.cellInsideCircle(outerCircle, point, config, 4 - threshold)(cell);
            };
        }
